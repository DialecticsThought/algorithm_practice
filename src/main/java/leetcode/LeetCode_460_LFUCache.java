...
public class LeetCode_460_LFUCache {
    ...
    private HashMap<Node, Bucket> heads; // 表示节点(Node)在哪个桶(NodeList)里
    ...
    public static class Bucket {
        ...
        public Bucket last; // 桶之间是双向链表所以有前一个桶
    ...
    private void move(Node node, Bucket oldBucket) {
        ...
        Bucket preList = modifyHeadList(oldBucket) ? oldBucket.last : oldBucket;
