...
public class LeetCode_87_ScrambleString {
    ...
    public static boolean process0(char[] str1, int L1, int R1, char[] str2, int L2, int R2) {
        ...
        /*
         * for循环的目的 把str1划分成2个部分
         *  [L1~leftEnd] 左  [leftEnd+1~R1]右  其中leftEnd=L1+N（N是for循环从0开始不断++）
         * 左部分 枚举
         * str1[L1]~str1[L1] 比较 str2[L2~L2+(L1-L1)] + str1[L1+1]~str1[R1] 比较 str2[L2+L1-L1+1,R2]
         *      || str1[L1]~str1[L1] 比较 str2[L2-(L1-L1)~L2] + str1[L1+1]~str1[R1] 比较 str2[L2,R2-(L1-L1)-1]
         *
         * str1[L1]~str1[L1+1] 比较 str2[L2~L2+(L1+1-L1)] + str1[L1+1]~str1[R1] 比较 str2[L2+L1+1-L1+1,R2]
         *      || str1[L1]~str1[L1+1] 比较 str2[L2-(L1+1-L1)~L2] + str1[L1+2]~str1[R1] 比较 str2[L2,R2-(L1+1-L1)-1]
         *
         * str1[L1]~str1[L1+2] 比较 str2[L2~L2+(L1+2-L1)] + str1[L1+2]~str1[R1] 比较 str2[L2+L1+2-L1+1,R2]
         *      || str1[L1]~str1[L1+2] 比较 str2[L2-(L1+2-L1)~L2] + str1[L1+3]~str1[R1] 比较 str2[L2,R2-(L1+2-L1)-1]
         *
         * .....
         * */
    ...
    public static void main(String[] args) {
        ...
        String str1="abcd";
        String str2="acbd";
        boolean scramble0 = isScramble0(str1, str2);
        System.out.println(scramble0);
    }
}
