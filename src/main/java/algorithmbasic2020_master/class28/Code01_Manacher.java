...
public class Code01_Manacher {
     ...
     * 此时 和普通做法一样，从 i 位置字符开始，向左右两侧扩出去检查，此时的“扩”过程没有获得加速
     ...
     * 如果 pR-1 位置以 index为中心对称
     *      那么 从“左大”位置到 pR-1 位置一定是以 index 为中心的回文串，我们把这个回文串叫作大回文串，同时把 pR-1 位置称为“右大”位置。
     *
     * 因为 回文半径数组 pArr 是从左到右计算的 => 位置 i 之前的所有位置都已经算过回文半径 ☆☆☆☆☆☆☆☆☆☆☆
     *
     * 位置 i 以 index 为中心向左对称过去的位置为 i’，同理 位置 i’的回文半径也是计算过的
     *      那么以 i’为中心的最大回文串大小（pArr[i’]）必然只有三种情况
     *
     * 假设以 i’为中心的最大回文串的左边界和右边界分别记为“左小”和“右小”。
     * eg：
     * 1. “左小”和“右小”完全在“左大”和“右大”内部，即以 i’为中心的最大回文串完全在以 index 为中心的最大回文串的内部
     *  [      a' ?        1        ? b'     |       b ?        1        ? a     ]
     *           左小      i'     右小                 左小'      i     右小'
     * 左大                                index                                右大
     *                                                                         pR-1
     ...
     * 如果处在情况一下，那么以位置 i为中心的最大回文串可以直接确定，就是从“右小'”到“左小'”这一段
     * 原因:
     * “左小”到“右小”这一段如果以 index 为回文中心，对应过去就是“右小'”到“左小'”这一段，
     * 那么“右小'”到“左小'”这一段就完全是“左小”到“右小”这一段的逆序。
     * 同时有“左小”到“右小”这一段又是回文串（以 i’为回文中心），
     * 所以“右小'”到“左小'”这一段一定也是回文串
     *
     * 也就是说，以位置 i 为中心的最大回文串起码是“右小'”到“左小'”这一段。
     * 另外，以位置 i’为中心的最大回文串只是“右小'”到“左小'”这一段，说明 a'!=b'。
