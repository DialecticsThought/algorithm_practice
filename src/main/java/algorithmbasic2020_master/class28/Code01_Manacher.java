...
public class Code01_Manacher {
     ...
     * 原因：
     * 1.首先 左大 <-> 左大' 这一段和 右大' <-> 右大 这一段是关于 index 对称的，
     * 所以 右大' <-> 右大 这一段是 左大 <-> 左大'这一段的逆序
     *
     * 2. 同时 左小 <-> 右小 这一段是回文串（以i’位置为中心），
     * 那么 左大 <-> 左大' 这一段也是回文串，左大 <-> 左大' 这一段的逆序也是回文串
     * 所以 右大' <-> 右大 这一段一定是回文串
     * 也就是说，以位置 i 为中心的最大回文串起码是右大'到右大这一段
     *
     * 3. 另外，左小到右小这一段是回文串，说明 a==b，b 和 c 关于 index 对称说明 b==c，左大 <-> 右大 这一段没有扩得更大，说明 a!=d，所以 d!=c
