...
public class Code01_Manacher {
     ...
     *          eg1: 如"#c#a#b#a#c#"，计算到 charArr[6...10]时，pR都为 11，此时 pR-1 包住了位置 6~10
     *          这种情况下，检查过程是可以获得优化的
     *          eg2：
     *           [                             ||                 |             ]
     *          左大                         index                i           右大
     ...
     *              1.如果 pR-1 位置以 index为中心对称, TODO 设 pR-1 位置 称为 右大位置 ☆☆☆☆☆
     *                   那么 从 左大 位置 到 右大 位置一定是以 index 为中心的回文串，我们把这个回文串叫作大回文串。
     ...
     * 左小 和 右小 完全在 左大 和 右大 内部，即以 i’为中心的最大回文串完全在以 index 为中心的最大回文串的内部
     *  [      a' ?        1        ? b'    ||      b ?        1        ? a     ]
     *  ↓         ↓        i'       ↓       V         ↓        i        ↓       ↓
     *  ↓        左小              右小     index     左小'             右小'     ↓
     * 左大                                                                    右大
