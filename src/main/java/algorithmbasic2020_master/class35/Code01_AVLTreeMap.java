package algorithmbasic2020_master.class35;

public class Code01_AVLTreeMap {
	/*
	* TODO 有序表 必须可以比较 所以继承Comparable
	* */
	public static class AVLNode<K extends Comparable<K>, V> {
		public K k;
		public V v;
		public AVLNode<K, V> l;//TODO 左子节点
		public AVLNode<K, V> r;//TODO 右子节点
		public int h;//TODO 整棵树高度
