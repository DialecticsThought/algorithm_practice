 ...
 * <<7 3> 1> <<6 100> 2> <<4 60> 3>
 * 有条信息 key=8 val=16 时间点4
 * <<6 100> 2> <<4 60> 3> <<8 16> 4>
 *TODO eg2：
 * 有一个双向链表 一个hashmap
 ...
 * 链表： <A,3> -> <B,7> -> <C,17> -> null
 * hashmap: <A,<A,3>> <B,<B,7>> <C,<C,17>>
 * 4.有条信息 key=B val=23 时间点4  执行update() B的info 放在了链表的最后面  B的enrty放在map的最后
 * 链表： <A,3> -> <C,17> -> <B,23>  -> null
 * hashmap: <A,<A,3>>  <C,<C,17>>  <B,<B,23>>
 * 5.执行get方法 得到A  A的info 放在了链表的最后面  A的enrty放在map的最后
 * 链表： <C,17> -> <B,23> ->  <A,3>  -> null
 * hashmap: <C,<C,17>> <B,<B,23>> <A,<A,3>>
 * 6.有条信息 key=D val=15 时间点6  执行add()
 * 链表： <B,23> -> <A,3> -> <D,15> -> null
 * hashmap:  <B,<B,23>> <A,<A,3>> <D,<D,15>>
 * ......
 */
