...
public class E05InsertionSort {
     ...
     * arr = 2 4 5 10 7 1
     *       0 1 2 3  4 5
     * 1.现在将arr[4]插入到已经排序的区域0 ~ 4 - 1 中
     *  1.1.从low-1开始向前遍历，设 i = low - 1
     *      arr[4-1] > arr[4] <=> 10 和 7
     *          => 交换 10 和 7 的位置 即 2 4 5 7 10 1
     *          => i--
     *      arr[3-1] < arr[3] || i < 0
     *          => 结束
     *  1.2. 将arr[4+1]插入到已经排序的区域0 ~ 4 中
     * 2.将arr[4+1]插入到已经排序的区域0 ~ 4 中
     *  2.1.从low-1开始向前遍历，设 i = low - 1
     *      arr[4-1] > arr[4] <=> 10 和 1
     ...
     *          => i--
     *      arr[2-1] > arr[2] <=> 4 和 1
     *          => 交换 4 和 1 的位置 即 2 1 4 5 7 10
     *          => i--
     *      arr[1-1] > arr[1] <=> 4 和 1
     *          => 交换 4 和 1 的位置 即 1 2 4 5 7 10
     *          => i--
     *      arr[3-1] < arr[3] || i < 0
     *          => 结束
     *  2.2. 将arr[5+1]插入到已经排序的区域0 ~ 5 中
     * 3.将arr[5+1]插入到已经排序的区域0 ~ 5 中
     *  => 5 == arr.len
     *     =>结束
     * </pre>
     * @param a
