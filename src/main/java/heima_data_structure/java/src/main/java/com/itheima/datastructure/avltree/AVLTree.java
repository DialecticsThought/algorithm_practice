...
public class AVLTree {
     ...
     *               ↘
     *               6
     *  2是粉红色节点  4是黄色节点   3是绿色节点也就是黄色节点的左孩子
     *  绿色节点需要换爹
     ...
     *    3(G)  5
     * 先以当前失衡节点的左子节点左旋：
     * 2是粉红色节点  4是黄色节点  3是绿色节点 也就是黄色节点的左孩子
     * 绿色节点需要换爹
     ...
     * 1  3
     * 再以当前失衡节点右旋
     * 此时 6是粉红色节点  4是黄色节点  5是绿色节点 也就是黄色节点的右孩子：
     * 绿色节点需要换爹
     ...
     *        3    5(G)
     * 先以当前节点的右子节点右旋：
     * 6是粉红色节点  4是黄色节点  5是绿色节点 也就是黄色节点的右孩子
     * 绿色节点需要换爹
     * 旋转的时候绿色节点作为粉红色节点的右孩子 因为右旋
     * 旋转后：
     *      2(P)
     ...
     *          5    7
     * 再以当前失衡节点右旋
     * 此时 2是粉红色节点  4是黄色节点  3是绿色节点 也就是黄色节点的左孩子：
     * 绿色节点需要换爹
     * 旋转的时候绿色节点作为粉红色节点的左孩子  因为左旋
     *          4
     *        ↙    ↘
