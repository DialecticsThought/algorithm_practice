...
import heima_data_structure.java.src.main.java.com.itheima.datastructure.binarytree.Leetcode111_2_E06;
...
public class TestLeetcode111_2E06 {
    ...
    public void test1() {
        ...
        assertEquals(2, new Leetcode111_2_E06().minDepth(root));
    }
    ...
    public void test3() {
        ...
        assertEquals(1, new Leetcode111_2_E06().minDepth(root));
    }
